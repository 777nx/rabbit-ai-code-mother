...
import com.fantasy.rabbitaicodemother.ai.AiCodeGenNameService;
import com.fantasy.rabbitaicodemother.ai.AiCodeGenNameServiceFactory;
import com.fantasy.rabbitaicodemother.ai.AiCodeGenTypeRoutingService;
import com.fantasy.rabbitaicodemother.ai.AiCodeGenTypeRoutingServiceFactory;
import com.fantasy.rabbitaicodemother.constant.AppConstant;
import com.fantasy.rabbitaicodemother.core.AiCodeGeneratorFacade;
import com.fantasy.rabbitaicodemother.core.builder.VueProjectBuilder;
import com.fantasy.rabbitaicodemother.core.handler.StreamHandlerExecutor;
...
import com.fantasy.rabbitaicodemother.model.enums.ChatHistoryMessageTypeEnum;
...
import com.fantasy.rabbitaicodemother.service.ChatHistoryService;
import com.fantasy.rabbitaicodemother.service.ScreenshotService;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    @Resource
    private AiCodeGenNameServiceFactory aiCodeGenNameServiceFactory;
    ...
    public Long createApp(AppAddRequest appAddRequest, User loginUser) {
        ...
        // 应用名称使用 AI 生成
        AiCodeGenNameService aiCodeGenNameService = aiCodeGenNameServiceFactory.createAiCodeGenNameService();
        String appName = aiCodeGenNameService.generateAppName(initPrompt);
    ...
    public String deployApp(Long appId, User loginUser) {
        ...
        if (!sourceDir.exists() || !sourceDir.isDirectory()) {
            throw new BusinessException(ErrorCode.SYSTEM_ERROR, "应用代码生成路径不存在，请先生成应用");
        }
        // 7. Vue 项目特殊处理，执行构建
        CodeGenTypeEnum codeGenTypeEnum = CodeGenTypeEnum.getEnumByValue(codeGenType);
    ...
    public boolean removeById(Serializable id) {
        ...
        // 先删除关联的对话历史
        try {
            chatHistoryService.deleteByMessage(appId);
        } catch (Exception e) {
