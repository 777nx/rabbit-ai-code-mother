package com.fantasy.rabbitaicodemother.generator;
...
public class MyBatisCodeGenerator {
    ...
    public static GlobalConfig createGlobalConfig() {
        ...
        globalConfig.getPackageConfig()
                .setBasePackage("com.fantasy.rabbitaicodemother.genresult");
        ...
        globalConfig.getJavadocConfig()
                .setAuthor("<a href=\"https://github.com/777nx\">Fantasy</a>")
                .setSince("");
